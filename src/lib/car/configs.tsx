...
export const resourceConfigs: CarResourceConfig[] = [
  {
    ...
    fields: [
      { name: "brand", title: "car.vehicle.brand", kind: "text", required: true, section: "car.form.section.identity" },
      { name: "model", title: "car.vehicle.model", kind: "text", required: true, section: "car.form.section.identity" },
      { name: "plate_number", title: "car.vehicle.plate_number", kind: "text", required: true, section: "car.form.section.identity" },
      { name: "color", title: "car.vehicle.color", kind: "text", section: "car.form.section.identity" },
      { name: "daily_rate", title: "car.vehicle.daily_rate", kind: "number", section: "car.form.section.commercial" },
      { name: "mileage", title: "car.vehicle.mileage", kind: "number", section: "car.form.section.commercial" },
      { name: "status", title: "car.vehicle.status.label", kind: "select", options: vehicleStatusOptions, section: "car.form.section.commercial", mutability: "domain" },
      {
        name: "branch",
        title: "car.vehicle.branch",
        kind: "relation",
        section: "car.form.section.assignment",
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "status", title: "car.branch.status.label", kind: "select", options: branchStatusOptions, mutability: "domain" },
    ],
    columns: [
  ...
  },
  {
    ...
    aiFill: {
      descriptionKey: "car.maintenance.aiFill.description",
      labelKey: "car.maintenance.aiFill.label",
      placeholderKey: "car.maintenance.aiFill.placeholder",
      instructions:
        "The vehicle is chosen by hand and is never part of your answer.",
    },
    fields: [
      {
        name: "vehicle",
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "status", title: "car.dispatch.status.label", kind: "select", options: dispatchStatusOptions, mutability: "domain" },
  ...
  },
  {
    ...
    aiFill: {
      descriptionKey: "car.violation.aiFill.description",
      labelKey: "car.violation.aiFill.label",
      placeholderKey: "car.violation.aiFill.placeholder",
      instructions:
        "The vehicle is chosen by hand and is never part of your answer. " +
        "An unpaid ticket is pending.",
    },
    fields: [
      {
        name: "vehicle",
      ...
      { name: "status", title: "car.violation.status.label", kind: "select", options: violationStatusOptions, mutability: "domain" },
  ...
  },
  {
    ...
    fields: [
      { name: "name", title: "car.customer.name", kind: "text", required: true, section: "car.form.section.identity" },
      { name: "phone", title: "car.customer.phone", kind: "text", section: "car.form.section.identity" },
      { name: "customer_type", title: "car.customer.type.label", kind: "select", options: customerTypeOptions, section: "car.form.section.identity" },
      { name: "company_name", title: "car.customer.company_name", kind: "text", section: "car.form.section.identity" },
      { name: "id_card", title: "car.customer.id_card", kind: "text", section: "car.form.section.licence" },
      { name: "driver_license", title: "car.customer.driver_license", kind: "text", section: "car.form.section.licence" },
      { name: "license_expiry", title: "car.customer.license_expiry", kind: "date", section: "car.form.section.licence" },
      { name: "email", title: "car.customer.email", kind: "text", section: "car.form.section.identity" },
      { name: "address", title: "car.customer.address", kind: "textarea", section: "car.form.section.account" },
      { name: "credit_level", title: "car.customer.credit_level.label", kind: "select", options: creditLevelOptions, section: "car.form.section.account" },
      { name: "status", title: "car.customer.status.label", kind: "select", options: customerStatusOptions, section: "car.form.section.account", mutability: "domain" },
      { name: "remark", title: "car.customer.remark", kind: "textarea", section: "car.form.section.account" },
    ],
    columns: [
  ...
  },
  {
    ...
    aiFill: {
      descriptionKey: "car.order.aiFill.description",
      labelKey: "car.order.aiFill.label",
      placeholderKey: "car.order.aiFill.placeholder",
      instructions:
        "The customer and the vehicle are chosen by hand and are never part of your answer. " +
        "A booking that has not started yet is reserved.",
    },
    fields: [
      { name: "order_no", title: "car.order.order_no", kind: "text", autoGenerated: true, section: "car.form.section.parties" },
      {
        name: "customer",
        title: "car.order.customer",
        kind: "relation",
        required: true,
        section: "car.form.section.parties",
      ...
      { name: "pickup_time", title: "car.order.pickup_time", kind: "datetime", section: "car.form.section.schedule" },
      { name: "expected_return", title: "car.order.expected_return", kind: "datetime", section: "car.form.section.schedule" },
      { name: "actual_return", title: "car.order.actual_return", kind: "datetime", section: "car.form.section.schedule", mutability: "domain" },
      { name: "daily_rate", title: "car.order.daily_rate", kind: "number", section: "car.form.section.charges", mutability: "create-only" },
      { name: "total_amount", title: "car.order.total_amount", kind: "number", section: "car.form.section.charges", mutability: "create-only" },
      { name: "status", title: "car.order.status.label", kind: "select", options: orderStatusOptions, section: "car.form.section.charges", mutability: "domain" },
      {
        name: "cancel_reason",
        title: "car.order.cancel_reason.label",
        kind: "select",
        options: cancelReasonOptions,
        section: "car.form.section.charges",
        mutability: "domain",
      },
    ],
    columns: [
  ...
  },
  {
    ...
    fields: [
      { name: "contract_no", title: "car.contract.contract_no", kind: "text", section: "car.form.section.parties" },
      {
        name: "order",
      ...
      { name: "sign_date", title: "car.contract.sign_date", kind: "date", section: "car.form.section.terms" },
      { name: "content", title: "car.contract.content", kind: "textarea", section: "car.form.section.terms" },
      { name: "status", title: "car.contract.status.label", kind: "select", options: contractStatusOptions, section: "car.form.section.terms", mutability: "domain" },
      { name: "attachments", title: "car.contract.attachments", kind: "attachment", section: "car.form.section.terms" },
    ],
    columns: [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "status", title: "car.todo.status", kind: "select", options: todoStatusOptions, mutability: "domain" },
      ...
      { name: "source_type", title: "car.todo.source_type", kind: "select", options: todoSourceTypeOptions, mutability: "domain" },
      { name: "source_id", title: "car.todo.source_id", kind: "number", mutability: "domain" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "amount", title: "car.payment.amount", kind: "number", mutability: "create-only" },
      { name: "deposit", title: "car.payment.deposit", kind: "number", mutability: "create-only" },
      { name: "refund", title: "car.payment.refund", kind: "number", mutability: "create-only" },
      { name: "payment_method", title: "car.payment.payment_method", kind: "select", options: paymentMethodOptions, mutability: "create-only" },
      { name: "payment_time", title: "car.payment.payment_time", kind: "datetime", mutability: "create-only" },
      { name: "status", title: "car.payment.status.label", kind: "select", options: paymentStatusOptions, mutability: "domain" },
    ],
    columns: [
